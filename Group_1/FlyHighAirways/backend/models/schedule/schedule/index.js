...
Schedule.seeds = seeds;

Schedule.createTable = async function (options) {
...
Schedule.createConstraints = async function (options) {
...
Schedule.createTriggers = async function(options){
...
Schedule.createAll = async function (options){
...
// Schedule.prototype.x = methods.x;

Schedule.seedTable = async function (options) {
